#!/usr/bin/env python3
"""Final health check script for DocuAgent - validates core functionality."""
...
def check_cli():
    ...
    try:
        ...
        result = subprocess.run([
            sys.executable, "-c", "import sys; sys.path.insert(0, '/home/akshar/PS5/src'); from docuagent.cli import main; main()", "--help"
...
def main():
    ...
    print("DocuAgent Health Check - Phase A Complete")
    print("=" * 60)
    ...
    if all_passed:
        print("🎉 PHASE A COMPLETE - ALL CHECKS PASSED!")
        print("\nCore functionality verified:")
        print("✓ All required modules import successfully")
        print("✓ Configuration file loads with required keys")
        print("✓ CLI commands are available and functional")
        print("✓ JSON output schema is correct")
        print("\nNext steps:")
        print("1. Proceed to Phase B - Active Learning Implementation")
        print("2. Create new directory structure for active learning modules")
        print("3. Implement error mining, uncertainty sampling, and pseudo-labeling")
        return 0
    else:
